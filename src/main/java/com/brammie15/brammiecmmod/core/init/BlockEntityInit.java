...
import com.brammie15.brammiecmmod.common.block.cm_centrifuge_new.NewCmCentrifugeBlockEntity;
...
public final class BlockEntityInit {
    ...
    public static final RegistryObject<BlockEntityType<NewCmCentrifugeBlockEntity>> CM_CENTRIFUGE = BLOCK_ENTITIES.register("cm_centrifuge", () -> BlockEntityType.Builder.of(NewCmCentrifugeBlockEntity::new, BlockInit.CM_CENTRIFUGE.get()).build(null));
